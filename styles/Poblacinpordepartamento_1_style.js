...
var style_Poblacinpordepartamento_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("pob");
    var labelText = "";
    size = 0;
    ...
    if (value >= 109555.000000 && value <= 454797.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 454797.000000 && value <= 891732.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 891732.000000 && value <= 1676315.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1676315.000000 && value <= 8445211.000000) {
            style = [ new ol.style.Style({
