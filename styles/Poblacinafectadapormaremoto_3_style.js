...
var style_Poblacinafectadapormaremoto_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("pocentaje");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.880000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.880000 && value <= 4.780000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.780000 && value <= 13.030000) {
            style = [ new ol.style.Style({
